...
public class HomeController {
    ...
    public String registerUser(
            ...
            BindingResult result1, // BindingResult for validation errors
        ...
        try {
            if (!agreement) {
                ...
                redirectAttributes.addFlashAttribute("message", new Message("You have not agreed to the terms and conditions !", "danger"));
            ...
            redirectAttributes.addFlashAttribute("message", new Message("Successfully Registered! Please log in.", "success"));
